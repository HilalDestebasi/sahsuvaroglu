...
import com.sahsuvaroglu.kgm.model.Car
import com.sahsuvaroglu.kgm.model.CarGeneralInfo
import com.sahsuvaroglu.kgm.model.CarI
import com.sahsuvaroglu.kgm.model.CarModel
import com.sahsuvaroglu.kgm.model.CarPrice
import com.sahsuvaroglu.kgm.model.ColorOptions
import com.sahsuvaroglu.kgm.model.Dimensions
import com.sahsuvaroglu.kgm.model.EngineAndPerformance
import com.sahsuvaroglu.kgm.model.EquipmentFeatures
import com.sahsuvaroglu.kgm.model.FuelConsumption
import com.sahsuvaroglu.kgm.model.Overview
import com.sahsuvaroglu.kgm.model.TechnicalSpecifications
    ...
    companion object {
        ...
        private fun createMussoGrand(): Car {
            return Car(
                ...
                priceList = listOf(
                    CarPrice(
                        "Model",
                        "GSR 2 Donanımlı Kampanyalı Anahtar Teslim Tavsiye Edilen Liste Fiyatı"
                    ),
                    CarPrice("Platinum D2.2 4x2 Otomatik (2024 Model)", "₺1.410.000"),
                    CarPrice("Platinum D2.2 4x4 Otomatik (2024 Model)", "₺1.489.412"),
                    CarPrice("Platinum Plus D2.2 4x2 Otomatik (2024 Model)", "₺1.560.000"),
                    CarPrice("Platinum Plus D2.2 4x4 Otomatik (2024 Model)", "₺1.624.412"),
                    CarPrice("Edition D2.2 4x4 Otomatik (2023 Model)", "₺1.832.776"),
                ),
                ...
                carModelList = listOf(
                    CarModel(
                        ...
                        "Dizel",
                        "4x2",
                        "₺1.410.000'den başlayan fiyatlarla",
                        R.drawable.musso_grand4
                    ),
                    CarModel(
                        "Platinum D2.2 4x4",
                        "Otomatik",
                        "Dizel",
                        "4x4",
                        "₺1.489.412'den başlayan fiyatlarla",
                        R.drawable.musso_grand8
                    ),
                    CarModel(
                        "Platinum Plus D2.2 4x2",
                        "Otomatik",
                        "Dizel",
                        "4x2",
                        "₺1.560.000'den başlayan fiyatlarla",
                        R.drawable.musso_grand4
                    ),
                    CarModel(
                        "Platinum Plus D2.2 4x4",
                        "Otomatik",
                        "Dizel",
                        "4x4",
                        "₺1.624.412'den başlayan fiyatlarla",
                        R.drawable.musso_grand8
                    ),
                ),
                car = listOf(
                    CarI(
                        ...
                        carGeneralInfo = CarGeneralInfo(
                            "Musso Grand Platinum D2.2 4x2 Otomatik",
                            "Otomatik",
                            "Dizel",
                            "4x2",
                            "₺1.410.000'den başlayan fiyatlarla"
                    ...
                    CarI(
                        ...
                        carGeneralInfo = CarGeneralInfo(
                            "Musso Grand Platinum D2.2 4x4 Otomatik",
                            "Otomatik",
                            "Dizel",
                            "4x4",
                            "₺1.489.412'den başlayan fiyatlarla"
        ...
        private fun createTorres(): Car {
            return Car(
                ...
                name = "Torres",
                priceList = listOf(
                    CarPrice("Model", "Kampanyalı Anahtar Teslim Tavsiye Edilen Liste Fiyatı"),
                    CarPrice("4x2 1.5 GDI Turbo (2023 Model)", "₺1.910.000"),
                    CarPrice("4x2 1.5 GDI Turbo (2024 Model)", "₺2.160.000"),
                    CarPrice("4x4 1.5 GDI Turbo (2023 Model)", "₺2.130.000"),
                    CarPrice("4x4 1.5 GDI Turbo (2024 Model)", "₺2.380.000")
                ),
                gallery = listOf("drawable/torres_gallery.jpg", "drawable/torres_gallery.jpg"),
                ...
                carModelList = listOf(
                    CarModel(
                        ...
                        "Benzinli",
                        "4x2",
                        "₺1.910.000'den başlayan fiyatlarla",
                        R.drawable.torres3
                    ),
                    CarModel(
                        "Torres 4x4",
                        ...
                        "Benzinli",
                        "4x4",
                        "₺2.130.000'den başlayan fiyatlarla",
                        R.drawable.torres2
                    ),
                ),
                car = listOf(
        ...
        private fun createTorresEvx(): Car {
            return Car(
                ...
                priceList = listOf(
                    ...
                    CarPrice("Torres EVX 4x2 (2024 Model)", "₺1.880.000")
                ),
                gallery = listOf(
                ...
                car = listOf(
                    CarI(
                        ...
                        carGeneralInfo = CarGeneralInfo(
                            "Torres EVX Torres EVX 4x2",
                            "Otomatik",
                            "Elektrik",
                            "4x2",
                            "₺1.880.000'den başlayan fiyatlarla"
                        ),
                        technicalSpecifications = TechnicalSpecifications(
                            overview = Overview(
                                doorCount = "5 Kapı",
