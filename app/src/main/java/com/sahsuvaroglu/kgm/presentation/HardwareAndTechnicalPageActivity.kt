...
import com.sahsuvaroglu.kgm.adapter.HardAdapter
import com.sahsuvaroglu.kgm.adapter.TechAdapter
        ...
        if (carName == "Torres EVX") {
            ...
            binding.apply {
                ...
                hardNTechPageInformation.text =
                    "• " + car.carGeneralInfo.transmission + "\n• " + car.carGeneralInfo.fuelType + "\n• " + car.carGeneralInfo.driveType
                hardNTechPagePriceInformation.text = car.carGeneralInfo.startingPrice
